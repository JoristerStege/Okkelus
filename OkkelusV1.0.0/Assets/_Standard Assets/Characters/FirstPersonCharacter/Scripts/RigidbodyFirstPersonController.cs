        ...
        private void Update()
        {
            ...
            if (Input.GetKeyDown(KeyCode.Joystick1Button1) || Input.GetKeyDown(KeyCode.LeftControl))
            {
                ...
                else
                {
                    ...
                    m_RigidBody.transform.position += new Vector3(0, 0.2f, 0);
                }
            }
        ...
        private void FixedUpdate()
        {
            ...
            if ((Mathf.Abs(input.x) > float.Epsilon || Mathf.Abs(input.y) > float.Epsilon) && (advancedSettings.airControl || m_IsGrounded))
            {
                ...
                else if (m_Crouching)
                {
                    ...
                    desiredMove.y = desiredMove.y * movementSettings.CurrentTargetSpeed * 0.5f;
                }
